...
DROP TYPE IF EXISTS bids CASCADE;
...
ALTER TABLE bids ADD CONSTRAINT fk_tradesmen FOREIGN KEY (tradesmen_id) REFERENCES tradesmen ON DELETE CASCADE;
ALTER TABLE bids ADD CONSTRAINT fk_projects FOREIGN KEY (project_id) REFERENCES projects ON DELETE CASCADE;
